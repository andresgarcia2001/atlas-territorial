"""Simplify map-data materialized-view geometry.
...
FULL_GEOMETRY_SQL = "ST_AsGeoJSON(t.geom)::json AS geometry"
...
def upgrade():
    ...
    create_map_data_mv(SIMPLIFIED_GEOMETRY_SQL)


def downgrade():
    op.execute("DROP MATERIALIZED VIEW IF EXISTS territory_indicator_map_data_mv;")
    create_map_data_mv(FULL_GEOMETRY_SQL)
